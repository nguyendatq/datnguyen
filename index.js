...
mongoose.connect('mongodb+srv://lol:123@cluster0.0dj7w.mongodb.net/dattt?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true }, function(err) {
    if (err) {
...
app.get("/car", controllerUser.quannam);
